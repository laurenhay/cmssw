...
JetConstituentTableProducer<T>::JetConstituentTableProducer(const edm::ParameterSet &iConfig)
    : name_(iConfig.getParameter<std::string>("name")),
      ...
      idx_name_(iConfig.getParameter<std::string>("idxName")),
      idx_nameSV_(iConfig.getParameter<std::string>("idxNameSV")),
...
void JetConstituentTableProducer<T>::fillDescriptions(edm::ConfigurationDescriptions &descriptions) {
  ...
  desc.add<std::string>("idxName", "candIdx");
  desc.add<std::string>("idxNameSV", "svIdx");
  desc.add<double>("jetRadius", true);
